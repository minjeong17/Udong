            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-800 mb-1 font-jua">
                  {profile.name} <span className="text-base text-orange-600 font-medium">(코스모스)</span>
                </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-medium font-gowun text-sm">dongari@university.ac.kr</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-orange-100 rounded-full flex items-center justify-center">
              ...
              <div>
                ...
                <p className="font-medium font-gowun text-sm">010-1234-5678</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-orange-100 rounded-full flex items-center justify-center">
              ...
              <div>
                <p className="text-xs text-gray-500 font-gowun">대학교</p>
                <p className="font-medium font-gowun text-sm">한국대학교</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-orange-100 rounded-full flex items-center justify-center">
              ...
              <div>
                ...
                <p className="font-medium font-gowun text-sm">국민은행 123-456-789012</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-orange-100 rounded-full flex items-center justify-center">
              ...
              <div>
                ...
                <p className="font-medium font-gowun text-sm">남성</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-orange-100 rounded-full flex items-center justify-center">
              ...
              <div>
                <p className="text-xs text-gray-500 font-gowun">활동 가능 시간</p>
                <p className="font-medium font-gowun text-sm">평일 저녁, 주말 오후</p>
              </div>
            </div>
          </div>
        </div>
