    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl shadow-xl border-2 border-gray-200 w-[500px] max-h-[600px] relative">
        ...
        <div className="text-center pt-6 pb-4 border-b border-gray-200">
          <h2 className="text-2xl font-bold text-black font-jua">미납자 알림 전송</h2>
          <p className="text-sm text-gray-600 font-maplestory font-bold mt-2">
        ...
        <div className="px-6 py-4 border-b border-gray-200">
          <div className="bg-red-50 border border-red-200 rounded-lg p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="font-semibold text-red-700 font-maplestory font-bold">알림 전송 대상</span>
            </div>
            <p className="text-sm text-red-600 font-maplestory font-bold">
        ...
        <div className="px-6 py-4 max-h-80 overflow-y-auto">
          <div className="space-y-3">
            {unpaidMembers.length === 0 ? (
              <div className="text-center py-8 text-black font-maplestory font-bold">
                현재 미납자가 없습니다.
              </div>
            ) : (
              unpaidMembers.map((member) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="font-medium text-black font-maplestory font-bold">
                      {member.userName}
                    </div>
                  ...
                  <span className="px-2 py-1 rounded text-xs font-medium bg-red-100 text-red-700 font-maplestory font-bold">
                    미납
                  </span>
                </div>
              ))
        ...
        <div className="px-6 py-4 border-t border-gray-200">
          <div className="flex items-center justify-between mb-4">
            <span className="text-sm text-black font-maplestory font-bold">
              알림 전송 대상: <span className="font-bold text-red-500">{unpaidMembers.length}명</span>
            </span>
            <span className="text-xs text-black font-maplestory font-bold">
